...
| ID | História de Usuário | Prioridade | Status | Critério de Aceite |
|---|---|---|---|---|
...
| RF-08 | Como **usuário**, quero pesquisar livros por título, autor ou gênero, para encontrar rapidamente o que procuro. | 🔴 Alta | ✅ Implementado | Resultados filtrados corretamente; mensagem "nenRFm resultado" quando não há correspondência. |
